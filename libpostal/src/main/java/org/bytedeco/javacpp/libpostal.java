...
public static class libpostal_normalize_options_t extends Pointer {
    ...
    @MemberGetter public native @Cast("char**") PointerPointer languages();  
...
public static class libpostal_address_parser_response_t extends Pointer {
    ...
    @MemberGetter public native @Cast("char**") PointerPointer components();
    ...
    @MemberGetter public native @Cast("char**") PointerPointer labels();
}
